...
# CUDA_VISIBLE_DEVICES=0 python Train_promix.py --cosine --dataset cifar10 --num_class 10 --rho_range 0.5,0.5 --tau 0.99 --pretrain_ep 10 --debias_output 0.8 --debias_pl 0.8  --noise_mode sym --noise_rate 0.5

# CUDA_VISIBLE_DEVICES=0 python Train_promix.py --cosine --dataset cifar10 --batch_size 512 --num_class 10 --rho_range 0.5,0.5 --tau 0.99 --pretrain_ep 10 --debias_output 0.8 --debias_pl 0.8  --noise_mode sym --noise_rate 0.5
...
#rand1
CUDA_VISIBLE_DEVICES=0 python Train_promix.py --noise_type rand1 --cosine --dataset cifar10 --num_class 10 --rho_range 0.5,0.5 --tau 0.99 --pretrain_ep 10  --noise_mode cifarn --wandb
#worst
